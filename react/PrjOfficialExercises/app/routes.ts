...
export default [
  ...
  route("/props_challenge_1", "./routes/ExerProps/exercise_01/App.jsx"),
  route("/props_my_version_1", "./routes/ExerProps/exercise_01/Attempt.jsx"),
  route("/props_challenge_2", "./routes/ExerProps/exercise_02/App.jsx"),
  route("/props_my_version_2", "./routes/ExerProps/exercise_02/Attempt.jsx"),
